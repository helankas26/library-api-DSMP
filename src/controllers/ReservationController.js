...
const expireReservations = asyncErrorHandler(async (req, resp, next) => {
    const reservations = await reservationService.expireReservations();
    await sendResponse(resp, 201, {reservations});
});
